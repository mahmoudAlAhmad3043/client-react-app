    ...
    <div className="mt-10 m-2">
      <form className="flex flex-col max-w-md m-auto text-start p-2 bg-slate-900 gap-1 text-slate-100 rounded-md">
        ...
        <input
          ...
          name="username"
          value={username}
          onChange={(e) => {setStateUserName(''); setUsername(e.target.value)}}
        ...
        <input
          ...
          name="username"
          value={password}
          onChange={(e) => {setStatePassword(''); setPassword(e.target.value)}}
          className="px-1 rounded-md outline-none focus:border-cyan-400 border-2 text-slate-900"
        />
        ...
        <input
          ...
          name="email"
          value={email}
          onChange={(e) =>{setStateEmail(''); setEmail(e.target.value)}}
          className="px-1 rounded-md outline-none focus:border-cyan-400 border-2 text-slate-900"
        />
        ...
        <div className='mt-4 text-center text-sm'>
                ...
                <Link  to={'/'} target='_self' className='text-cyan-400'>login</Link>
            </div>
      </form>
    </div>
  );
